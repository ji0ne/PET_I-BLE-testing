...
import { fonts, fontSize } from '../utils/fonts.ts';
import RippleEffect from '../components/RippleEffect';
import { SERVICE_UUID, STATUS_UUID } from './BleConstants';
const ConnectDevice = () => {
    ...
    const onChangeCharacteristics = (serviceUUID: any, result: any, item: any) => {
        ...
        result.forEach((characteristic: any) => {
            ...
            if (characteristicUUID === STATUS_UUID || characteristicUUID === HUMIDITY_UUID) {
